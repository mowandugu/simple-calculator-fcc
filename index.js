...
class App extends React.Component {
    ...
    render() {
        const { currNumber, calc } = this.state;
        ...
        nums.map((num) => 
        React.createElement("button", { className: `dark-grey ${num === 0 && 'big-h'}`, key: num, onClick: this.handleClick, id: ids[num] },
        num)), 
        ...
        ops.map((op) => 
        React.createElement("button", { className: "orange", key: op, onClick: this.handleClick, id: ids[op] }, op)), 
